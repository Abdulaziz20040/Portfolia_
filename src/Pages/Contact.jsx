      ...
      >
        ...
        <Flex gap={5}>
          <Box
            ...
            boxShadow={
              isDark ? "" : "5px 5px 15px #D1D9E6, -5px -5px 15px #ffffff"
            }
            borderRadius="7px"
            p={3}
          >
          ...
          <Box>
            ...
            <Text>frontenddevelopment17@gmail.com</Text>
          </Box>
        </Flex>
        <Flex gap={5}>
          <Box
          ...
          <Box>
            ...
            <Text>+77 014 50 47</Text>
            <Text>+93 311 50 47</Text>
          </Box>
        </Flex>
        <Flex gap={5}>
          <Box
          ...
          <Box>
            ...
            <Text>Beruniy Shah Street 3a, 100020, Uzbekistan</Text>
            <Text>Toshkent</Text>
          </Box>
        </Flex>
        <Text mb={-8} textTransform={"uppercase"} fontWeight={700}>
          social info
        </Text>
        <Social />
      </Box>
      <Box
        background={
          isDark
            ...
            : "linear-gradient(30deg, rgba(213, 222, 235), rgba(245, 245, 245))"
        }
        borderRadius="10px"
        p={3}
        flexBasis={"60%"}
