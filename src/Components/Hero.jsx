  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text
          fontSize={{ base: "20px", sm: "25px", md: "40px", lg: "40px" }}
          fontWeight={700}
        >
          Hi,👋I&#x27;m{" "}
          <Text as="span" textColor={"#FD185E"}>
            Abdulaziz Abdushukurov
          </Text>
        </Text>
        <Text
          fontWeight={700}
        ...
        <Text
          ...
          textAlign={"left"}
        >
          Enthusiastic and technically adept front-end developer with a robust
          foundation in HTML, CSS, and JavaScript. Demonstrated commitment to
          coding excellence and a proactive approach to problem-solving.
        </Text>
        <Box>
